...
-- prepend_path("MODULEPATH", "/lfs/software/modules/linux-rocky8-x86_64/mpich/3.4.3-njy7jva/gcc/12.1.0")
prepend_path("MODULEPATH", "/lfs/software/modules/linux-rocky8-x86_64/mpich/3.4.3/gcc/12.1.0")
